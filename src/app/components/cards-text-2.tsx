export default function CardT2() {
    return(
        <div className="w-full h-full px-[25px] py-[25px] flex flex-col gap-[10px]">
            <h5 className="font-Montserrat font-bold text-[24px] tracking-[0.1px] text-[#252B42]">Luxury homeware</h5>
            <h5 className="font-Montserrat font-bold text-[14px] leading-[24px] tracking-[0.2px] text-[#737373]">Get it First</h5>
