      ...
      <div className="w-full bg-[#FAFAFA] py-8">
        <div className="container mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 ml-[90px] lg:ml-[70px]">
          {[cat1, cat2, cat3, cat4, cat5].map((cat, index) => (
            <div
              key={index}
              className="w-full max-w-[200px] mx-auto transform transition-transform duration-300 hover:scale-105"
            >
              <Image
                src={cat}
      ...
      <div className="relative w-full px-4 py-12">
        <div className="container mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          {[
            ...
            <div
              key={index}
              className="w-full max-w-[238px] mx-auto mb-8 flex flex-col items-center transform transition-transform duration-300 hover:scale-105"
            >
              <div className="w-[239px] h-[427px] flex flex-col">
                <div className="flex-grow relative overflow-hidden rounded-lg shadow-md">
                  <Image
                    src={pic}
                    alt={`product ${index + 1}`}
